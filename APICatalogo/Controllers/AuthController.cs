        ...
        public async Task<IActionResult> AddUserToRole(string email, string roleName)
        {
            ...
            if (user != null)
            {
                ...
                else
                {
                    ...
                    return StatusCode(StatusCodes.Status400BadRequest, new Response { Status = "Error", Message = $"Unable to add user {user.Email} to the {roleName} role." });
                }
            }
            return StatusCode(StatusCodes.Status400BadRequest, new Response { Status = "Error", Message = $"Unable to find user" });
        }
    }
}
